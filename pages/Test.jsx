          ...
          <footer className={styles.footer} id="nosotros">
            ...
            <div>
              ...
              <div className={styles.footerItemsContainer}>
                ...
                <p>Ser el medio impreso y digital de mayor influencía en la construcción de un Inmobiliria ciudadana en torno a la realidad nacional e Servicios profesionales.</p>
              </div>
            </div>
            <div>
              <h5>DIRECCIÓN</h5>
